...
$(document).ready(function () {
    ...
    function ActionBarViewModel() {
        ...
        self.tooltipMove = ko.observable('!LOC(live_game_action_bar:move.message):MOVE');
        self.tooltipAttack = ko.observable('!LOC(live_game_action_bar:attack.message):ATTACK');
        self.tooltipAltFire = ko.observable('!LOC(live_game_action_bar:alt_fire.message):ALT-FIRE');
        self.tooltipAssist = ko.observable('!LOC(live_game_action_bar:assist.message):ASSIST');
        self.tooltipRepair = ko.observable('!LOC(live_game_action_bar:repair.message):REPAIR');
        self.tooltipReclaim = ko.observable('!LOC(live_game_action_bar:reclaim.message):RECLAIM');
        self.tooltipPatrol = ko.observable('!LOC(live_game_action_bar:patrol.message):PATROL');
        self.tooltipUse = ko.observable('!LOC(live_game_action_bar:use.message):USE');
        self.tooltipSpecialMove = ko.observable('!LOC(live_game_action_bar:special_move.message):SPECIAL-MOVE');
        self.tooltipUnload = ko.observable('!LOC(live_game_action_bar:unload.message):UNLOAD');
        self.tooltipLoad = ko.observable('!LOC(live_game_action_bar:load.message):LOAD');
        self.tooltipStop = ko.observable('!LOC(live_game_action_bar:stop.message):STOP');        
        ...
        self.energyOrders = ko.observableArray(['consume', 'conserve', 'auto']); 
        ...
        self.selectedEnergyOrderImage = ko.computed(function() {
            var images = [
                ...
                'img/orders_bar/icons_orders_energy_auto.png' 
            ];
